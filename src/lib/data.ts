...
export const teachersData = [
  {
    ...
    name: "Maude Harper",
    email: "pefpuwfo@ireko.td",
    photo:
      "https://images.pexels.com/photos/2888150/pexels-photo-2888150.jpeg?auto=compress&cs=tinysrgb&w=1200",
    phone: "1234567890",
    subjects: ["Math", "Geometry"],
    classes: ["1B", "2A", "3C"],
    address: "95 Cajvod Parkway",
  },
  {
    id: 2,
    teacherId: "1234567890",
    ...
    classes: ["5A", "4B", "3C"],
    address: "864 Idesiw Ridge",
  },
  {
    id: 3,
    teacherId: "1234567890",
    name: "Lenora Richardson",
    email: "joevu@imciz.jm",
    photo:
      "https://images.pexels.com/photos/428328/pexels-photo-428328.jpeg?auto=compress&cs=tinysrgb&w=1200",
    phone: "1234567890",
    subjects: ["Biology"],
    classes: ["5A", "4B", "3C"],
    address: "898 Vibi Park",
  },
  {
    id: 4,
    teacherId: "1234567890",
    ...
    subjects: ["History"],
    classes: ["5A", "4B", "3C"],
    address: "1109 Dadam Parkway",
  },
  {
    id: 5,
    teacherId: "1234567890",
    name: "Herbert Jordan",
    email: "ejodaza@met.pr",
    photo:
      "https://images.pexels.com/photos/1102341/pexels-photo-1102341.jpeg?auto=compress&cs=tinysrgb&w=1200",
    phone: "1234567890",
    subjects: ["Music", "History"],
    classes: ["5A", "4B", "3C"],
    address: "1824 Docza Court",
  },
  {
    id: 6,
    teacherId: "1234567890",
    name: "Genevieve Farmer",
    email: "evitakkez@le.com",
    photo:
      "https://images.pexels.com/photos/712513/pexels-photo-712513.jpeg?auto=compress&cs=tinysrgb&w=1200",
    phone: "1234567890",
    subjects: ["Physics"],
    classes: ["5A", "4B", "3C"],
    address: "1481 Igda Path",
  },
  {
    id: 7,
    teacherId: "1234567890",
    name: "Sadie Clark",
    email: "ikowta@gacir.nc",
    photo:
      "https://images.pexels.com/photos/1438081/pexels-photo-1438081.jpeg?auto=compress&cs=tinysrgb&w=1200",
    phone: "1234567890",
    subjects: ["English", "Spanish"],
    classes: ["5A", "4B", "3C"],
    address: "1972 Bugfe Way",
  },
  {
    id: 8,
    teacherId: "1234567890",
    ...
    subjects: ["Math", "Geometry"],
    classes: ["5A", "4B", "3C"],
    address: "615 Hesfup Circle",
  },
  {
    id: 9,
    teacherId: "1234567890",
    name: "Corey Abbott",
    email: "vilhuv@wocej.th",
    photo:
      "https://images.pexels.com/photos/842980/pexels-photo-842980.jpeg?auto=compress&cs=tinysrgb&w=1200",
    phone: "1234567890",
    subjects: ["Literature", "English"],
    classes: ["5A", "4B", "3C"],
    address: "1448 Kilek Avenue",
  },
  {
    id: 10,
    teacherId: "1234567890",
    name: "Luis Hodges",
    email: "fiagukit@hiozakoj.pk",
    photo:
      "https://images.pexels.com/photos/1043474/pexels-photo-1043474.jpeg?auto=compress&cs=tinysrgb&w=1200",
    phone: "1234567890",
    subjects: ["Biology"],
    classes: ["5A", "4B", "3C"],
    address: "1903 Vopse River",
  },
];
...
export const calendarEvents = [
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 2, 3, 13, 30),
    end: new Date(2025, 2, 3, 14, 15),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 2, 3, 9, 45),
    end: new Date(2025, 2, 3, 10, 30),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 2, 3, 8, 30),
    end: new Date(2025, 2, 3, 9, 15),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 2, 6, 15, 0),
    end: new Date(2025, 2, 6, 15, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
  ...
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 2, 8, 10, 30),
    end: new Date(2025, 2, 8, 11, 15),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 2, 9, 14, 15),
    end: new Date(2025, 2, 9, 15, 0),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 2, 10, 13, 45),
    end: new Date(2025, 2, 10, 14, 30),
  },
  {
    title: "Physics",
    allDay: false,
...

  {
    title: "History",
    allDay: false,
    start: new Date(2025, 2, 12, 16, 30),
    end: new Date(2025, 2, 12, 17, 15),
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 2, 13, 8, 45),
    end: new Date(2025, 2, 13, 9, 30),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 2, 14, 12, 0),
    end: new Date(2025, 2, 14, 12, 45),
  },

  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 2, 15, 11, 15),
    end: new Date(2025, 2, 15, 12, 0),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 2, 16, 14, 30),
    end: new Date(2025, 2, 16, 15, 15),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 2, 17, 13, 15),
    end: new Date(2025, 2, 17, 14, 0),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 2, 18, 9, 30),
    end: new Date(2025, 2, 18, 10, 15),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 2, 19, 15, 45),
  ...
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 2, 21, 12, 30),
    end: new Date(2025, 2, 21, 13, 15),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 2, 22, 10, 15),
...

  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 2, 23, 14, 45),
    end: new Date(2025, 2, 23, 15, 30),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 2, 24, 9, 15),
    end: new Date(2025, 2, 24, 10, 0),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 2, 25, 16, 0),
    end: new Date(2025, 2, 25, 16, 45),
  },
];
